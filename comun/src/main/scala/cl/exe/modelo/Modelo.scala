...
case class Receptor(id : EntidadId, nombre : String, descripcion: String, canalTransmisionId : EntidadId, formatoId: EntidadId, plantillaId : EntidadId, periodicidadId : EntidadId, propiedades : Map[String, String], habilitado : Boolean)